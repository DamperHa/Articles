...
def set_logger(name, save_dir, distributed_rank):
...
if __name__ == '__main__':
   ...
   # parser.add_argument('--dataset',
    ...
    parser.add_argument('--dataset',
                        default="cifar10", choices={'cifar10', 'lsun', 'imagenet', 'folder', 'lfw', 'fake', 'mnist'},
                        help='Type of the dataset to be used.')


    parser.add_argument('--dataroot',
                        default="D:\\4I\\0.1COM\\Temple_MNIST_tensorflowX\\GAN",
    ...
    parser.add_argument('--output-dir',
                        default='D:\\4I\\0.1COM\\Temple_MNIST_tensorflowX\\GAN\\zyw',
